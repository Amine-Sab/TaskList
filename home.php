                ...
                <div class="col-md-6 offset-md-3">
                    <!-- add todo -->
                            <div id="add-btn" class=" d-flex justify-content-center mt-5">
                                    <span  class="btn btn-primary"><i class="fa-solid fa-plus"></i> Add task</span>    
                            </div>
                            <div id="add-todo-form" class="mt-5">
                                <form action="assets/backend/todo.php" method="post" >
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" id="add-todo" name="add-todo" placeholder="Enter your task here"  >
